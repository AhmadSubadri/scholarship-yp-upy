                    ...
                    <div class="container mx-auto px-4 h-full flex items-center">
                        <div class="max-w-2xl text-white">
                            <h1 class="text-4xl md:text-5xl font-bold mb-4">
                                Selamat Datang di Portal Beasiswa YP UPY
                            </h1>
                            <p class="text-xl mb-8">
                                Program beasiswa untuk mendukung pendidikan berkualitas di Universitas PGRI Yogyakarta
                            </p>
                            <a href="<?= base_url('scholarships') ?>"
                                class="inline-flex items-center px-6 py-3 border border-transparent text-base font-medium rounded-md text-white bg-blue-500 hover:bg-blue-400">
                                Lihat Beasiswa
